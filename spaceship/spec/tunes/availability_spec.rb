...
describe Spaceship::Tunes::Availability do
  ...
  describe "update_availability!" do
    it "inspect works" do
      itc_stub_app_remove_territory

      availability = client.update_availability!(app.apple_id, ["US"])
    ...
    describe "with countries as strings" do
      it "correctly adds a country" do
        itc_stub_app_add_territory

        # currently countries in list is US and GB
        availability = client.update_availability!(app.apple_id, ["FR", "GB", "US"])
    ...
    describe "with countries as Territories" do
      it "correctly adds a country" do
        ...
        availability = client.update_availability!(app.apple_id, territories)
    ...
    it "correctly unincludes all future territories" do
      itc_stub_app_uninclude_future_territories

      # currently countries in list is US and GB
      availability = client.update_availability!(app.apple_id, ["GB", "US"], include_future_territories: false)
